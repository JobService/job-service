...
import com.hpe.caf.services.job.client.model.CancelJobs200Response;
import com.hpe.caf.services.job.client.model.DeleteJobs200Response;
...
public class JobServiceIT {
    ...
    public void testHealthCheck() throws NoSuchAlgorithmException, KeyManagementException, IOException
    {
        ...
        final String responseString = IOUtils.toString(responseEntity.getContent(), StandardCharsets.UTF_8);
    ...
    public void testCancelJobsByLabel() throws ApiException {
        ...
        final CancelJobs200Response response = jobsApi.cancelJobs(defaultPartitionId, correlationId, null,
        "tag:1", null);
