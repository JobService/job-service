...
public class JobTrackingWorkerConfiguration {
    ...
    public String getJobDatabaseConnectionString() {
        return jobDatabaseConnectionString;
    }

    public void setJobDatabaseConnectionString(String jobDatabaseConnectionString) {
