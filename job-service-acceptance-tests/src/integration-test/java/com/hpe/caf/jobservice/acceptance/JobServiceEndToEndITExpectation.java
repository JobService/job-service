...
public class JobServiceEndToEndITExpectation {
    ...
    public JobServiceEndToEndITExpectation(boolean expectJobCancellation, String trackTo, final String partition, String jobId, String correlationId, String taskClassifier, int taskApiVersion, TaskStatus taskStatus, ExampleWorkerStatus workerResultStatus, List<String> workerItemAssetIds) {
