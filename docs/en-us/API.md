...
info:
  ...
  description: |
    ...
    Users can check on the progress of operations, and request them to be
...
paths:
  ...
  /jobs/{jobId}/isActive:
    ...
    get:
      tags:
        - Jobs
      summary: Checks if the job is active
      description: Checks if the specified job is active
