...
public class HealthCheckTest {
    ...
    public void testHealthCheckWithUnavailableDatabaseAndRabbitMQ() throws Exception
    {
        ...
        TestEnvironmentVariablesOverrider.configureEnvironmentVariable("JOB_DATABASE_URL",
                "jdbc:postgresql://UNKNOWNHOST1234567890:9999/jobservicedb");
        TestEnvironmentVariablesOverrider.configureEnvironmentVariable("JOB_DATABASE_APPNAME", "unknownapplicationname");
        TestEnvironmentVariablesOverrider.configureEnvironmentVariable("JOB_DATABASE_USERNAME", "unknownuser");
        TestEnvironmentVariablesOverrider.configureEnvironmentVariable("JOB_DATABASE_PASSWORD", "unknownpass");
