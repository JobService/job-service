...
public class JobStatsApiServiceImpl extends JobStatsApiService {
    ...
    @Override
    public Response getJobStatsCount(final String jobservicePartition, final String jobIdStartsWith, final String statusType, String cAFCorrelationId, SecurityContext securityContext)
            throws Exception {
        try {
            Long jobsCount = JobsStatsGetCount.getJobsCount(jobservicePartition, jobIdStartsWith, statusType);
