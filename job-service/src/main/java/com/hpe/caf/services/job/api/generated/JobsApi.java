...
public class JobsApi  {
    ...
    public Response getJobs(
            ...
            @ApiParam(value = "Filter to jobs with the specified labels and values, in the format label=<labelName>:<value1>,<value2>") @QueryParam("label") List<String> labels,
            @Context SecurityContext securityContext)
            throws Exception {
        return delegate.getJobs(partitionId, jobIdStartsWith, statusType, limit, offset, cAFCorrelationId, sort, labels, securityContext);
    }
