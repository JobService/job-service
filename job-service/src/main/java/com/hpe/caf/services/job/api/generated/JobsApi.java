...
public class JobsApi  {
    ...
    public Response getJobs(
            ...
            @ApiParam(value = "All - no status filter is applied (Default); NotCompleted - only those results with statuses other than " +
                    ...
                    " those results with inactive statuses (i.e. Completed, Expìred, Failed, Cancelled) will be returned; NotFinished -" +
                    " only those results with unfinished statuses (ie. Active, Paused, Waiting) will be returned.") @QueryParam("statusType") String statusType,
