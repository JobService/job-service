...
public abstract class JobStatsApiService {
    ...
    public abstract Response getJobStatsCount(final String partitionId, final String jobIdStartsWith, final String statusType, String cAFCorrelationId,SecurityContext securityContext)
            throws Exception;
