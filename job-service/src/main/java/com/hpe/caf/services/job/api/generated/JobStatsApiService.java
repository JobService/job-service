...
public abstract class JobStatsApiService {
    ...
    public abstract Response getJobStatsCount(final String partition, final String jobIdStartsWith, final String statusType, String cAFCorrelationId,SecurityContext securityContext)
            throws Exception;
