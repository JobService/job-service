...
/*
 *  Name: internal_update_job_progress_from_array
 *
 *  Description:
 *  Updates the percentage_complete in the job table with data from subtask_report table from array.
 */
CREATE FUNCTION internal_update_job_progress_from_array(in_partition_id VARCHAR(40),
                                             job_id_array VARCHAR(128)[])
    RETURNS VOID
